...
@ManagedBean
@SessionScoped
public class managerStockApiBean {
            ...
            if (key.equals("Meta Data")) {
                ...
                for (String subKey : dataJsonObj.keySet()) {
                    ...
                    if (i == 0) {
                        ...
                        this.table2Markup += "<td><a class='btn btn-success' href='" + path + "/faces/managerPurchase.xhtml?symbol=" + symbol + "&price=" + subJsonObj.getString("4. close") + "'>Make Transaction</a></td>";
                    }
