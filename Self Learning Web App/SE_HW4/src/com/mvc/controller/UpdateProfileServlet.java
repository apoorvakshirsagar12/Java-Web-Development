...
public class UpdateProfileServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String query = "select user_id,f_name,l_name from users where u_name='"+uname+"'";
			...
			rs.next();
				...
				output = output + "<div class='field'><label for='pass'>Current Password :&nbsp;</label><input type='password' placeholder='Enter the password to update your profile' class='login username-field' name='passwd' required/></div>"
