					...
					<div class="nav-collapse">
						<ul class="nav pull-right">
							<li class="dropdown"><a href="#" class="dropdown-toggle"
								data-toggle="dropdown"><i class="icon-user"></i> <%=session.getAttribute("uName")%>
									<b class="caret"></b></a>
						...
						<div id="menu" class="menu-menu-1-container">
							<ul id="menu-menu-1" class="ddsmoothmenu">
								...
								<li id="menu-item-31"
									...
									href="bookparking.jsp">Book Parking Space</a></li>

								<li id="menu-item-31"
									class="menu-item menu-item-type-post_type menu-item-object-page menu-item-31"><a
									href="vehiclemanagement.jsp">Manage Vehicles</a></li>
								<li id="menu-item-31"
									class="menu-item menu-item-type-post_type menu-item-object-page menu-item-31"><a
									href="parkingLocator.jsp">Parking Locator</a></li>
							</ul>
						</div>
					</div>
				</div>
